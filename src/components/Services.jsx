  ...
  return (
    <div>
        ...
        <div className='grid grid-cols-1 mg:grid-cols-2 lg:grid-cols-3 gap-10'>
            <div>
                <div className='p-9 flex flex-col bg-[#121315] rounded-xl'>
            ...
            <div>
                <div className='p-9 flex flex-col bg-[#121315] rounded-xl'>
                    <h5 className='text-[#FF0073] text-2xl font-bold mb-5'> {'<Desarrolo de aplicaciones/>'}</h5>
                    <p className='text-[#dcdcdc] text-base '> Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit, debitis. Illo, ullam cum molestias, eos recus</p>
                </div>
            </div>
    ...
    <div class="pepe">
        <h3 className='flex text-xl text-bold text-[#C3FF00] ml-28 >'> {'<Services/>'} </h3>
    </div>
    </div>
  )
}
